...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("starting", "running", "stopped", "error", "killed", name="botstatus"), nullable=False, server_default="stopped"),
    ...
    op.create_table(
        ...
        sa.Column("lifecycle", sa.Enum("draft", "backtest", "paper", "live", "retired", name="strategylifecycle"), nullable=False, server_default="draft"),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("bot_instance_id", sa.Integer(), sa.ForeignKey("bot_instances.id"), nullable=True),
        sa.Column("kill_type", sa.Enum("soft_kill", "hard_kill", name="killtype"), nullable=False),
        sa.Column("trigger", sa.Enum("manual", "heartbeat", "drawdown", name="killtrigger"), nullable=False),
