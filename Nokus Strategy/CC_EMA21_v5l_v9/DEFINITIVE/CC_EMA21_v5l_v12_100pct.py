...
class CC_EMA21_v5l_v12_100pct(IStrategy):
    ...
    # ── Hyperopt best params (ep1: IS +35.0% DD 11.5% WR 61.5% | OOS +35.2% DD 3.93% WR 68.6%) ──
    buy_params = {
        "atr_sl_mult": 0.13,
        "buy_pull_tol": 1.012,
        "buy_rsi_high": 57,
    ...
    def custom_stake_amount(self, current_time, current_rate: float,
        ...
        """1% risk sizing: gubitak po tradu = 2% kapitala. SL cap 2%."""
        ...
        quantity = (total_equity * 0.02) / risk_per_unit
